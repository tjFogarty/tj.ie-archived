...
/* harmony import */ var _upvotes_Upvotes_svelte__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./upvotes/Upvotes.svelte */ "./src/js/upvotes/Upvotes.svelte");
...
Object(_utils__WEBPACK_IMPORTED_MODULE_0__["ready"])(async () => {
  ...
  if (upvotesContainer) {
    new _upvotes_Upvotes_svelte__WEBPACK_IMPORTED_MODULE_3__["default"]({
...
/* harmony import */ var _stores__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stores */ "./src/js/upvotes/stores.js");
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./api */ "./src/js/upvotes/api.js");
/* src/js/upvotes/Upvotes.svelte generated by Svelte v3.5.3 */
...
function create_else_block_1(ctx) {
	var button, svg, use, t, dispose;

	function select_block_type_2(ctx) {
		if (ctx.currentRecord) return create_if_block_2;
	...
	return {
		c() {
			...
			use = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["svg_element"])("use");
			t = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["space"])();
			if_block.c();
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["xlink_attr"])(use, "xlink:href", "#heart");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(svg, "class", "c-upvote-button__icon");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(button, "class", "c-upvote-button");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(button, "type", "button");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(button, "aria-label", "Show your appreciation by tapping or clicking");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(button, "title", "Like this post");
			dispose = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["listen"])(button, "click", ctx.handleClickUpvote);
		},
		...
		m(target, anchor) {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["append"])(svg, use);
...
// (33:0) {#if hasBeenClicked}
function create_if_block(ctx) {
	var div, svg, use, t, span;

	function select_block_type_1(ctx) {
		if (ctx.currentRecord) return create_if_block_1;
	...
	return {
		c() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["xlink_attr"])(use, "xlink:href", "#heart");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(svg, "class", "c-upvote-button__icon");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(div, "class", "c-upvote-button is-active");
		},
...
function create_else_block_2(ctx) {
	...
	return {
		c() {
			span = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["element"])("span");
			span.textContent = "Be the first to like this!";
		},
...
// (57:4) {#if currentRecord}
function create_if_block_2(ctx) {
	var span, t_value = ctx.currentRecord.votes, t;
	...
	return {
		...
		p(changed, ctx) {
			if ((changed.currentRecord) && t_value !== (t_value = ctx.currentRecord.votes)) {
...
function create_else_block(ctx) {
	...
	return {
		c() {
			t = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["text"])("1");
		},
...
// (39:6) {#if currentRecord}
function create_if_block_1(ctx) {
	var t_value = ctx.parseInt(ctx.currentRecord.votes, 10) + 1, t;
	...
	return {
		...
		p(changed, ctx) {
			if ((changed.currentRecord) && t_value !== (t_value = ctx.parseInt(ctx.currentRecord.votes, 10) + 1)) {
				Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["set_data"])(t, t_value);
			}
		},
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx) {
		if (ctx.hasBeenClicked) return create_if_block;
...
function instance($$self, $$props, $$invalidate) {
  ...
  let { currentRecord, hasBeenClicked = false } = $$props;

  _stores__WEBPACK_IMPORTED_MODULE_2__["record"].subscribe(value => {
    $$invalidate('currentRecord', currentRecord = value)
  })

  Object(svelte__WEBPACK_IMPORTED_MODULE_1__["onMount"])(async () => {
    const response = await _api__WEBPACK_IMPORTED_MODULE_3__["fetchUpvotes"]()
    const { results } = await response.json()
    _stores__WEBPACK_IMPORTED_MODULE_2__["records"].set(results)
  })

  function handleClickUpvote() {
    const { pathname } = document.location
    $$invalidate('hasBeenClicked', hasBeenClicked = true)

    if (!currentRecord) {
      _api__WEBPACK_IMPORTED_MODULE_3__["createNewRecord"](pathname)
      return
    }

    const { rowIndex, votes } = currentRecord
    _api__WEBPACK_IMPORTED_MODULE_3__["addUpvote"]({ rowIndex, votes: parseInt(votes, 10) + 1 })
  }

	$$self.$set = $$props => {
		if ('currentRecord' in $$props) $$invalidate('currentRecord', currentRecord = $$props.currentRecord);
		if ('hasBeenClicked' in $$props) $$invalidate('hasBeenClicked', hasBeenClicked = $$props.hasBeenClicked);
	};
...
class Upvotes extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponent"] {
	constructor(options) {
		super();
		Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["init"])(this, options, instance, create_fragment, svelte_internal__WEBPACK_IMPORTED_MODULE_0__["safe_not_equal"], ["currentRecord", "hasBeenClicked"]);
	}
}

/* harmony default export */ __webpack_exports__["default"] = (Upvotes);

/***/ }),

/***/ "./src/js/upvotes/api.js":
/*!*******************************!*\
  !*** ./src/js/upvotes/api.js ***!
  \*******************************/
/*! exports provided: fetchUpvotes, addUpvote, createNewRecord */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchUpvotes", function() { return fetchUpvotes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addUpvote", function() { return addUpvote; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createNewRecord", function() { return createNewRecord; });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/js/upvotes/constants.js");


const baseUrl = `https://api.sheetson.com/v1/sheets/${_constants__WEBPACK_IMPORTED_MODULE_0__["SHEET_NAME"]}`
const headers = new Headers({
  'X-Sheetson-Spreadsheet-Id': _constants__WEBPACK_IMPORTED_MODULE_0__["SHEET_ID"],
...
function addUpvote({ rowIndex, votes }) {
  return fetch(request(`/${rowIndex}`, 'PUT', { votes }))
}

function createNewRecord(url) {
...
/***/ "./src/js/upvotes/constants.js":
/*!*************************************!*\
  !*** ./src/js/upvotes/constants.js ***!
  \*************************************/
/*! exports provided: SHEET_NAME, SHEET_ID */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SHEET_NAME", function() { return SHEET_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SHEET_ID", function() { return SHEET_ID; });
const SHEET_NAME = 'upvotes'
const SHEET_ID = '1QvOEyvtjq0ByJ0TZDLJHECL0oKmlH4EAHGXde9AIqp8'



/***/ }),

/***/ "./src/js/upvotes/stores.js":
/*!**********************************!*\
  !*** ./src/js/upvotes/stores.js ***!
  \**********************************/
/*! exports provided: records, record */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const records = Object(svelte_store__WEBPACK_IMPORTED_MODULE_0__["writable"])([])

const record = Object(svelte_store__WEBPACK_IMPORTED_MODULE_0__["derived"])(records, $records => {
