...
function create_else_block_1(ctx) {
	...
	var if_block = (ctx.currentRecord) && create_if_block_2(ctx);
	...
	return {
		c() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(button, "class", "c-upvote-button js-add-upvote");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(button, "type", "button");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(button, "aria-label", "Show your appreciation by tapping or clicking the heart");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(button, "title", "Like this post");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["toggle_class"])(button, "is-active", ctx.hasBeenClicked);
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["xlink_attr"])(use, "xlink:href", "#heart");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(svg, "class", "c-upvote-button__icon");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(span, "class", "js-upvote-count");
...
function instance($$self, $$props, $$invalidate) {
  ...
  async function handleClickUpvote() {
    ...
    if (!currentRecord) {
      await _api__WEBPACK_IMPORTED_MODULE_3__["createNewRecord"](pathname)
    } else {
      const { rowIndex, url, votes } = currentRecord
      await _api__WEBPACK_IMPORTED_MODULE_3__["addUpvote"]({ rowIndex, url, votes: parseInt(votes, 10) + 1 })
    }
  }
...
function addUpvote({ rowIndex, url, votes }) {
